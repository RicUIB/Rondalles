...
pdf_file <- normalizePath("pdf_aplec/Aplech_Tom_VIII_1924.pdf", mustWork = TRUE)
...
# Archivos de salida
output_csv <- "raw_text/rondalles_ocr_tomo8.csv"
output_txt <- "raw_text/rondalles_ocr_tomo8.txt"
