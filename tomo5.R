...
pdf_file <- normalizePath("pdf_aplec/Aplech_Tom_V_1924.pdf", mustWork = TRUE)
...
# Archivos de salida
output_csv <- "raw_text/rondalles_ocr_tomo5.csv"
output_txt <- "raw_text/rondalles_ocr_tomo5.txt"
