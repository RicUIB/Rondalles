...
pdf_file <- normalizePath("pdf_aplec/Aplec_Tom_III_1913.pdf", mustWork = TRUE)
...
# Archivos de salida
output_csv <- "raw_text/rondalles_ocr_tomo3.csv"
output_txt <- "raw_text/rondalles_ocr_tomo3.txt"
