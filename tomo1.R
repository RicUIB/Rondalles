...
pdf_file <- normalizePath("pdf_aplec/Aplec_Tom_I_1915.pdf", mustWork = TRUE)
...
# Archivos de salida
output_csv <- "rondalles_ocr_tomo1.csv"
output_txt <- "rondalles_ocr_tomo1.txt"
...
saveRDS(df, "raw_text/rondalles_ocr_tomo1.rds")
